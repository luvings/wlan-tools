...
static inline FLOAT round_and_return(mp_limb_t *retval, int exponent, int negative,
...
/* Shift {PTR, SIZE} COUNT bits to the left, and fill the vacated bits
   ...
   --drepper */
static inline void __mpn_lshift_1(mp_limb_t *ptr, mp_size_t size, unsigned int count,
                                  mp_limb_t limb)
{
