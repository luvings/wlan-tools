...
unsigned long inetstr2int(const char *str)
{
...
nis_error __do_niscall3(dir_binding *dbp, u_long prog, xdrproc_t xargs, caddr_t req,
...
nis_error __do_niscall2(const nis_server *server, u_int server_len, u_long prog,
...
nis_error __nisfind_server(const_nis_name name, directory_obj **dir)
{
	if (name == NULL)
		return NIS_BADNAME;
...
nis_error __do_niscall(const_nis_name name, u_long prog, xdrproc_t xargs,
