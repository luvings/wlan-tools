...
static enum nss_status internal_setspent(ent_t *ent)
{
...
static enum nss_status getspent_next_nis_netgr(const char *name, struct spwd *result, ent_t *ent,
...
static enum nss_status getspent_next_nisplus_netgr(const char *name, struct spwd *result,
...
static enum nss_status getspent_next_nisplus(struct spwd *result, ent_t *ent, char *buffer,
                size_t buflen, int *errnop)
{
	int parse_res;
	size_t p2len;
...
static enum nss_status getspent_next_nis(struct spwd *result, ent_t *ent,
...
static enum nss_status getspnam_plususer(const char *name, struct spwd *result, char *buffer,
                size_t buflen, int *errnop)
{
	struct parser_data *data = (void *) buffer;
	struct spwd pwd;
