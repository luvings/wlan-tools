...
static int _nss_nisplus_parse_rpcent(nis_result *result, struct rpcent *rpc,
...
enum nss_status _nss_nisplus_setrpcent(int stayopen)
{
...
static enum nss_status internal_nisplus_getrpcent_r(struct rpcent *rpc, char *buffer,
...
enum nss_status _nss_nisplus_getrpcent_r(struct rpcent *result, char *buffer,
                size_t buflen, int *errnop)
{
	int status;
...
enum nss_status _nss_nisplus_getrpcbyname_r(const char *name, struct rpcent *rpc,
                char *buffer, size_t buflen, int *errnop)
{
	int parse_res;
...
enum nss_status _nss_nisplus_getrpcbynumber_r(const int number, struct rpcent *rpc,
                char *buffer, size_t buflen, int *errnop)
{
	if (tablename_val == NULL) {
		enum nss_status status = _nss_create_tablename(errnop);
