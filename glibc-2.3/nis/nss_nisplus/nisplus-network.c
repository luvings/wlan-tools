...
static int _nss_nisplus_parse_netent(nis_result *result, struct netent *network,
...
enum nss_status _nss_nisplus_setnetent(int stayopen)
{
...
static enum nss_status internal_nisplus_getnetent_r(struct netent *network, char *buffer,
...
enum nss_status _nss_nisplus_getnetent_r(struct netent *result, char *buffer,
                size_t buflen, int *errnop, int *herrnop)
{
	int status;
...
enum nss_status _nss_nisplus_getnetbyname_r(const char *name, struct netent *network,
                char *buffer, size_t buflen, int *errnop,
                int *herrnop)
{
...
enum nss_status _nss_nisplus_getnetbyaddr_r(uint32_t addr, const int type,
