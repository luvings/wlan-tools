...
enum nss_status _nss_nisplus_setspent(int stayopen)
{
...
static enum nss_status internal_nisplus_getspent_r(struct spwd *sp, char *buffer, size_t buflen,
                int *errnop)
{
	int parse_res;
...
enum nss_status _nss_nisplus_getspent_r(struct spwd *result, char *buffer, size_t buflen,
                                        int *errnop)
{
	int status;
...
enum nss_status _nss_nisplus_getspnam_r(const char *name, struct spwd *sp,
