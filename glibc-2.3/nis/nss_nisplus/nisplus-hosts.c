...
static int _nss_nisplus_parse_hostent(nis_result *result, int af, struct hostent *host,
...
enum nss_status _nss_nisplus_sethostent(int stayopen)
{
...
static enum nss_status internal_nisplus_gethostent_r(struct hostent *host, char *buffer,
...
enum nss_status _nss_nisplus_gethostent_r(struct hostent *result, char *buffer,
                size_t buflen, int *errnop, int *herrnop)
{
	int status;
...
static enum nss_status internal_gethostbyname2_r(const char *name, int af, struct hostent *host,
                char *buffer, size_t buflen, int *errnop,
...
enum nss_status _nss_nisplus_gethostbyname2_r(const char *name, int af, struct hostent *host,
                char *buffer, size_t buflen, int *errnop,
                int *herrnop)
{
...
#if 0
enum nss_status _nss_nisplus_getipnodebyname_r(const char *name, int af, int flags,
...
enum nss_status _nss_nisplus_gethostbyaddr_r(const void *addr, socklen_t addrlen, int af,
