...
static enum nss_status _nss_nisplus_parse_netgroup(struct __netgrent *result, char *buffer,
...
enum nss_status _nss_nisplus_setnetgrent(const char *group, struct __netgrent *dummy)
{
	enum nss_status status;
...
enum nss_status _nss_nisplus_endnetgrent(struct __netgrent *dummy)
{
	__libc_lock_lock(lock);
