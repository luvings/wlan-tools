...
static int _nss_nisplus_parse_aliasent(nis_result *result, unsigned long entry,
...
static enum nss_status internal_setaliasent(void)
{
...
static enum nss_status internal_nisplus_getaliasent_r(struct aliasent *alias,
...
enum nss_status _nss_nisplus_getaliasent_r(struct aliasent *result, char *buffer,
                size_t buflen, int *errnop)
{
	int status;
...
enum nss_status _nss_nisplus_getaliasbyname_r(const char *name, struct aliasent *alias,
                char *buffer, size_t buflen, int *errnop)
{
	int parse_res;
