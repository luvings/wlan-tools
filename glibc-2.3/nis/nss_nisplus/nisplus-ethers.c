...
static int _nss_nisplus_parse_etherent(nis_result *result, struct etherent *ether,
...
enum nss_status _nss_nisplus_setetherent(int stayopen)
{
...
static enum nss_status internal_nisplus_getetherent_r(struct etherent *ether, char *buffer,
...
enum nss_status _nss_nisplus_getetherent_r(struct etherent *result, char *buffer,
                size_t buflen, int *errnop)
{
	int status;
...
enum nss_status _nss_nisplus_gethostton_r(const char *name, struct etherent *eth,
                char *buffer, size_t buflen, int *errnop)
{
	int parse_res;
...
enum nss_status _nss_nisplus_getntohost_r(const struct ether_addr *addr,
                struct etherent *eth,
                char *buffer, size_t buflen, int *errnop)
{
	if (tablename_val == NULL) {
