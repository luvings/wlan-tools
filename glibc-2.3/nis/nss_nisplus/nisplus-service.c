...
static int _nss_nisplus_parse_servent(nis_result *result, struct servent *serv,
...
enum nss_status _nss_nisplus_setservent(int stayopen)
{
...
static enum nss_status internal_nisplus_getservent_r(struct servent *serv, char *buffer,
...
enum nss_status _nss_nisplus_getservent_r(struct servent *result, char *buffer,
                size_t buflen, int *errnop)
{
	int status;
...
enum nss_status _nss_nisplus_getservbyname_r(const char *name, const char *protocol,
                struct servent *serv,
                char *buffer, size_t buflen, int *errnop)
{
	int parse_res;
...
enum nss_status _nss_nisplus_getservbyport_r(const int number, const char *protocol,
                struct servent *serv,
                char *buffer, size_t buflen, int *errnop)
{
	if (tablename_val == NULL) {
