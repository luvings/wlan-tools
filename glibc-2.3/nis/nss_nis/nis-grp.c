...
enum nss_status _nss_nis_setgrent(int stayopen)
{
...
enum nss_status _nss_nis_endgrent(void)
{
	__libc_lock_lock(lock);
...
static enum nss_status internal_nis_getgrent_r(struct group *grp, char *buffer, size_t buflen,
                int *errnop)
{
...
enum nss_status _nss_nis_getgrent_r(struct group *result, char *buffer, size_t buflen,
                                    int *errnop)
{
	int status;
...
enum nss_status _nss_nis_getgrnam_r(const char *name, struct group *grp,
...
enum nss_status _nss_nis_getgrgid_r(gid_t gid, struct group *grp,
                                    char *buffer, size_t buflen, int *errnop)
{
	struct parser_data *data = (void *) buffer;
	enum nss_status retval;
