...
static enum nss_status internal_setgrent(intern_t *intern)
{
	char *domainname;
...
static enum nss_status internal_getgrent_r(struct group *grp, char *buffer, size_t buflen,
...
enum nss_status _nss_nis_initgroups_dyn(const char *user, gid_t group, long int *start,
