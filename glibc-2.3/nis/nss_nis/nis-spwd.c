...
enum nss_status _nss_nis_setspent(int stayopen)
{
...
enum nss_status _nss_nis_endspent(void)
{
	__libc_lock_lock(lock);
...
enum nss_status _nss_nis_getspent_r(struct spwd *result, char *buffer, size_t buflen,
                                    int *errnop)
{
	int status;
...
enum nss_status _nss_nis_getspnam_r(const char *name, struct spwd *sp,
