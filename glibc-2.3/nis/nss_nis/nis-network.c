...
enum nss_status _nss_nis_setnetent(int stayopen)
{
...
enum nss_status _nss_nis_endnetent(void)
{
	__libc_lock_lock(lock);
...
static enum nss_status internal_nis_getnetent_r(struct netent *net, char *buffer, size_t buflen,
...
enum nss_status _nss_nis_getnetent_r(struct netent *net, char *buffer, size_t buflen,
                                     int *errnop, int *herrnop)
{
...
enum nss_status _nss_nis_getnetbyname_r(const char *name, struct netent *net, char *buffer,
...
enum nss_status _nss_nis_getnetbyaddr_r(uint32_t addr, int type, struct netent *net,
