...
static int _nss_nis_parse_aliasent(const char *key, char *alias, struct aliasent *result,
...
enum nss_status _nss_nis_endaliasent(void)
{
	__libc_lock_lock(lock);
...
static enum nss_status internal_nis_getaliasent_r(struct aliasent *alias, char *buffer,
...
enum nss_status _nss_nis_getaliasent_r(struct aliasent *alias, char *buffer, size_t buflen,
                                       int *errnop)
{
...
enum nss_status _nss_nis_getaliasbyname_r(const char *name, struct aliasent *alias,
                char *buffer, size_t buflen, int *errnop)
{
	enum nss_status retval;
	int parse_res;
