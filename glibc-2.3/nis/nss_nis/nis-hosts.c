...
enum nss_status _nss_nis_sethostent(int stayopen)
{
...
enum nss_status _nss_nis_endhostent(void)
{
	__libc_lock_lock(lock);
...
static enum nss_status internal_nis_gethostent_r(struct hostent *host, char *buffer,
...
enum nss_status _nss_nis_gethostent_r(struct hostent *host, char *buffer, size_t buflen,
...
enum nss_status _nss_nis_gethostbyname_r(const char *name, struct hostent *host, char *buffer,
                size_t buflen, int *errnop, int *h_errnop)
{
...
enum nss_status _nss_nis_gethostbyaddr_r(const void *addr, socklen_t addrlen, int af,
...
#if 0
enum nss_status _nss_nis_getipnodebyname_r(const char *name, int af, int flags,
