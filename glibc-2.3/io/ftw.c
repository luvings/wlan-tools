...
static inline int add_object(struct ftw_data *data, struct STAT *st)
{
...
static inline int open_dir_stream(struct ftw_data *data, struct dir_data *dirp)
{
	int result = 0;
...
static inline int process_entry(struct ftw_data *data, struct dir_data *dir, const char *name,
                                size_t namlen)
{
	struct STAT st;
	int result = 0;
...
static int
internal_function ftw_dir(struct ftw_data *data, struct STAT *st)
{
	struct dir_data dir;
	struct dirent64 *d;
...
static int
internal_function ftw_startup(const char *dir, int is_nftw, void *func, int descriptors,
                              int flags)
{
...
int FTW_NAME(path, func, descriptors)
const char *path;
FTW_FUNC_T func;
int descriptors;
{
...
int NFTW_NAME(path, func, descriptors, flags)
const char *path;
NFTW_FUNC_T func;
int descriptors;
int flags;
