...
static _IO_ssize_t _IO_cookie_read(fp, buf, size)
_IO_FILE *fp;
void *buf;
_IO_ssize_t size;
{
...
static _IO_ssize_t _IO_cookie_write(fp, buf, size)
_IO_FILE *fp;
const void *buf;
_IO_ssize_t size;
{
...
static _IO_off64_t _IO_cookie_seek(fp, offset, dir)
_IO_FILE *fp;
_IO_off64_t offset;
int dir;
{
...
static int _IO_cookie_close(fp)
_IO_FILE *fp;
{
	struct _IO_cookie_file *cfile = (struct _IO_cookie_file *) fp;
...
_IO_FILE *_IO_fopencookie(cookie, mode, io_functions)
void *cookie;
const char *mode;
...
static _IO_off64_t _IO_old_cookie_seek(fp, offset, dir)
_IO_FILE *fp;
_IO_off64_t offset;
int dir;
{
...
_IO_FILE *_IO_old_fopencookie(cookie, mode, io_functions)
void *cookie;
const char *mode;
_IO_cookie_io_functions_t io_functions;
{
