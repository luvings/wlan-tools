...
static int _IO_obstack_overflow(_IO_FILE *fp, int c)
{
...
static _IO_size_t _IO_obstack_xsputn(_IO_FILE *fp, const void *data, _IO_size_t n)
{
	struct obstack *obstack = ((struct _IO_obstack_file *) fp)->obstack;
...
int _IO_obstack_vprintf(struct obstack *obstack, const char *format, va_list args)
{
	struct obstack_FILE {
