...
void _IO_old_file_finish(fp, dummy)
_IO_FILE *fp;
int dummy;
{
	if (_IO_file_is_open(fp)) {
...
_IO_FILE *_IO_old_file_fopen(fp, filename, mode)
_IO_FILE *fp;
const char *filename;
const char *mode;
{
...
_IO_FILE *_IO_old_file_attach(fp, fd)
_IO_FILE *fp;
int fd;
{
	if (_IO_file_is_open(fp))
...
_IO_FILE *_IO_old_file_setbuf(fp, p, len)
_IO_FILE *fp;
char *p;
_IO_ssize_t len;
{
...
int _IO_old_do_write(fp, data, to_do)
_IO_FILE *fp;
const char *data;
_IO_size_t to_do;
{
...
static
int old_do_write(fp, data, to_do)
_IO_FILE *fp;
const char *data;
_IO_size_t to_do;
{
...
int _IO_old_file_overflow(f, ch)
_IO_FILE *f;
int ch;
{
...
_IO_off64_t _IO_old_file_seekoff(fp, offset, dir, mode)
_IO_FILE *fp;
_IO_off64_t offset;
int dir;
int mode;
...
_IO_ssize_t _IO_old_file_write(f, data, n)
_IO_FILE *f;
const void *data;
_IO_ssize_t n;
{
...
_IO_size_t _IO_old_file_xsputn(f, data, n)
_IO_FILE *f;
const void *data;
_IO_size_t n;
{
