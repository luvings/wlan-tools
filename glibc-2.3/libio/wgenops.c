...
_IO_ssize_t _IO_least_wmarker(fp, end_p)
_IO_FILE *fp;
wchar_t *end_p;
{
...
unsigned _IO_adjust_wcolumn(start, line, count)
unsigned start;
const wchar_t *line;
int count;
{
...
void _IO_init_wmarker(marker, fp)
...
int _IO_seekwmark(fp, mark, delta)
_IO_FILE *fp;
struct _IO_marker *mark;
int delta;
{
