...
static enum __codecvt_result do_unshift(struct _IO_codecvt *codecvt, __mbstate_t *statep,
...
static enum __codecvt_result do_in(struct _IO_codecvt *codecvt, __mbstate_t *statep,
