...
void _IO_wstr_init_static(fp, ptr, size, pstart)
_IO_FILE *fp;
wchar_t *ptr;
int size;
wchar_t *pstart;
...
void _IO_wstr_init_readonly(fp, ptr, size)
_IO_FILE *fp;
const char *ptr;
int size;
{
...
_IO_wint_t _IO_wstr_overflow(fp, c)
_IO_FILE *fp;
_IO_wint_t c;
{
...
_IO_wint_t _IO_wstr_underflow(fp)
_IO_FILE *fp;
{
	if (fp->_wide_data->_IO_write_ptr > fp->_wide_data->_IO_read_end)
		fp->_wide_data->_IO_read_end = fp->_wide_data->_IO_write_ptr;
...
_IO_off64_t _IO_wstr_seekoff(fp, offset, dir, mode)
_IO_FILE *fp;
_IO_off64_t offset;
int dir;
int mode;
...
_IO_wint_t _IO_wstr_pbackfail(fp, c)
_IO_FILE *fp;
_IO_wint_t c;
{
