...
const char *
internal_function _nl_get_alt_digit(unsigned int number, struct locale_data *current)
{
	const char *result;
...
const wchar_t *
internal_function _nl_get_walt_digit(unsigned int number, struct locale_data *current)
{
...
int
internal_function _nl_parse_alt_digit(const char **strp, struct locale_data *current)
{
	const char *str = *strp;
	int result = -1;
	size_t cnt;
