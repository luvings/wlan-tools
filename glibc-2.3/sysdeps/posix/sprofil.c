...
static inline unsigned long int pc_to_index(size_t pc, size_t offset, unsigned int scale, int prof_uint)
{
...
static inline void profil_count(void *pcp, int prof_uint)
{
