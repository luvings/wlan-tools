...
static inline void INTR_MSG_BACK_OUT(struct mips_thread_state *state)
{
	return;
}
...
static inline int SYSCALL_EXAMINE(struct mips_thread_state *state, int *callno)
{
...
static inline mach_port_t MSG_EXAMINE(struct mips_thread_state *state, int *msgid)
{
	mach_msg_header_t *msg;
