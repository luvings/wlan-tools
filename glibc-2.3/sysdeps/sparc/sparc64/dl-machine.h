...
static inline void sparc64_fixup_plt(struct link_map *map, const Elf64_Rela *reloc,
...
static inline void elf_machine_rela(struct link_map *map, const Elf64_Rela *reloc,
