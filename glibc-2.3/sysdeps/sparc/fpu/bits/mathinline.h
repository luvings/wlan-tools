...
__MATH_INLINE double sqrt(double __x) __THROW {
	register double __r;
	__asm("fsqrtd %1,%0" : "=f"(__r) : "f"(__x));
	return __r;
}

__MATH_INLINE float sqrtf(float __x) __THROW {
	register float __r;
...
#   if __WORDSIZE == 64
__MATH_INLINE long double sqrtl(long double __x) __THROW {
	long double __r;
...
__MATH_INLINE double __ieee754_sqrt(double __x)
{
	register double __r;
	__asm("fsqrtd %1,%0" : "=f"(__r) : "f"(__x));
	return __r;
...
__MATH_INLINE float __ieee754_sqrtf(float __x)
{
	register float __r;
	__asm("fsqrts %1,%0" : "=f"(__r) : "f"(__x));
	return __r;
...
#   if __WORDSIZE == 64
__MATH_INLINE long double __ieee754_sqrtl(long double __x)
{
	long double __r;
	extern void _Qp_sqrt(long double *, __const__ long double *);
	_Qp_sqrt(&__r, &__x);
