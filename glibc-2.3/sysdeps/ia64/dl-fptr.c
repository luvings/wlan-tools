...
boot_table:
	{
len:
		sizeof(local.boot_fdescs) / sizeof(local.boot_fdescs[0]),
		first_unused: 0
	}
};
...
static struct ia64_fdesc *new_fdesc_table(struct local *l)
{
...
static Elf64_Addr make_fdesc(Elf64_Addr ip, Elf64_Addr gp)
{
...
static inline Elf64_Addr *make_fptr_table(struct link_map *map)
{
...
Elf64_Addr __ia64_make_fptr(struct link_map *map, const Elf64_Sym *sym, Elf64_Addr ip)
{
