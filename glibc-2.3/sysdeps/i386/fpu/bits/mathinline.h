...
__MATH_INLINE int __signbitl(long double __x) __THROW {
...
__MATH_INLINE void __sincosf(float __x, float *__sinx, float *__cosx) __THROW {
	__sincos_code;
}

__MATH_INLINE void __sincosl(long double __x, long double *__sinx, long double *__cosx) __THROW {
	__sincos_code;
}
# endif
...
__inline_mathcodeNP(floor, __x, \
                    ...
                    return __value) __inline_mathcodeNP(ceil, __x, \
                            register long double __value;						      \
                            __volatile unsigned short int __cw;					      \
                            __volatile unsigned short int __cwtmp;				      \
                            __asm __volatile("fnstcw %0" : "=m"(__cw));				      \
...
__inline_mathcodeNP(log1p, __x, \
		...
		/* The argument range of the inline version of asinhl is slightly reduced.  */ __inline_mathcodeNP(asinh, __x, \
...
__MATH_INLINE long double ldexpl(long double __x, int __y) __THROW {
	__ldexp_code;
}
...
__MATH_INLINE long int lrintl(long double __x) __THROW {
	__lrint_code;
}
#undef __lrint_code
...
#define __llrint_code \
  ...
  return __llrintres
__MATH_INLINE long long int llrintf(float __x) __THROW {
	__llrint_code;
}
__MATH_INLINE long long int llrint(double __x) __THROW {
	__llrint_code;
}
__MATH_INLINE long long int llrintl(long double __x) __THROW {
	__llrint_code;
}
#undef __llrint_code
...
__MATH_INLINE int __finite(double __x) __THROW {
