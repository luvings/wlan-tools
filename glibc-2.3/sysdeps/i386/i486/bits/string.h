...
__STRING_INLINE void *__memcpy_by2(void *__dest, __const void *__src, size_t __n)
{
	register unsigned long int __d0, __d1;
	register void *__tmp = __dest;
	__asm__ __volatile__
...
__STRING_INLINE int memcmp(__const void *__s1, __const void *__s2, size_t __n)
{
	register unsigned long int __d0, __d1, __d2;
	register int __res;
	__asm__ __volatile__
...
# ifdef __USE_GNU
__STRING_INLINE void *rawmemchr(const void *__s, int __c)
{
...
__STRING_INLINE char *__mempcpy_by4(char *__dest, __const char *__src, size_t __srclen)
{
	register char *__tmp = __dest;
	register unsigned long int __d0, __d1;
	__asm__ __volatile__
...
__STRING_INLINE char *__mempcpy_by2(char *__dest, __const char *__src, size_t __srclen)
{
	register char *__tmp = __dest;
	register unsigned long int __d0, __d1;
	__asm__ __volatile__
...
__STRING_INLINE char *__mempcpy_byn(char *__dest, __const char *__src, size_t __srclen)
{
...
__STRING_INLINE char *__strncpy_byn(char *__dest, __const char __src[], size_t __srclen, size_t __n)
{
	register unsigned long int __d0, __d1;
	register char *__tmp = __dest;
	__asm__ __volatile__
...
__STRING_INLINE char *__strcat_c(char *__dest, __const char __src[], size_t __srclen)
{
#ifdef __i686__
	register unsigned long int __d0;
	register char *__tmp;
...
__STRING_INLINE size_t __strcspn_cg(__const char *__s, __const char __reject[], size_t __reject_len)
{
	register unsigned long int __d0, __d1, __d2;
...
__STRING_INLINE size_t __strspn_cg(__const char *__s, __const char __accept[], size_t __accept_len)
{
	register unsigned long int __d0, __d1, __d2;
	register __const char *__res;
	__asm__ __volatile__
...
__STRING_INLINE char *__strpbrk_cg(__const char *__s, __const char __accept[], size_t __accept_len)
{
	register unsigned long int __d0, __d1, __d2;
	register char *__res;
	__asm__ __volatile__
