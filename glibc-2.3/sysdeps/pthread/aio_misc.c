...
void
internal_function __aio_free_request(struct requestlist *elem)
{
	elem->running = no;
...
struct requestlist *
internal_function __aio_find_req(aiocb_union *elem)
{
...
struct requestlist *
internal_function __aio_find_req_fd(int fildes)
{
	struct requestlist *runp = requests;
...
void
internal_function __aio_remove_request(struct requestlist *last, struct requestlist *req,
                                       int all)
{
