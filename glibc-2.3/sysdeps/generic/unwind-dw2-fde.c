...
static saddr fde_unencoded_compare(struct object *ob __attribute__((unused)),
                                   fde *x, fde *y)
{
	return *(saddr *)x->pc_begin - *(saddr *)y->pc_begin;
}

static saddr fde_single_encoding_compare(struct object *ob, fde *x, fde *y)
{
...
static saddr fde_mixed_encoding_compare(struct object *ob, fde *x, fde *y)
{
...
static inline fde *binary_search_unencoded_fdes(struct object *ob, void *pc)
{
...
static inline fde *binary_search_single_encoding_fdes(struct object *ob, void *pc)
{
	struct fde_vector *vec = ob->u.sort;
	int encoding = ob->s.b.encoding;
...
static inline fde *binary_search_mixed_encoding_fdes(struct object *ob, void *pc)
{
	struct fde_vector *vec = ob->u.sort;
	size_t lo, hi;
