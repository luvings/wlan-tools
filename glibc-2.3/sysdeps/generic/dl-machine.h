...
static inline void elf_machine_rel(Elf32_Addr loadaddr, Elf32_Dyn *info[DT_NUM],
...
static inline Elf32_Addr elf_machine_rela(Elf32_Addr loadaddr, Elf32_Dyn *info[DT_NUM],
                const Elf32_Rel *reloc, const Elf32_Sym *sym,
                Elf32_Addr(*resolve)(const Elf32_Sym **ref,
                                     Elf32_Addr reloc_addr,
                                     int noplt))
