...
static char *
internal_function w_addmem(char *buffer, size_t *actlen, size_t *maxlen, const char *str,
                           size_t len)
{
...
static char *
internal_function w_addstr(char *buffer, size_t *actlen, size_t *maxlen, const char *str)
/* (lengths exclude trailing zero) */
{
	/* Add a string to the buffer, allocating room for it if needed.
	 */
...
static int
internal_function w_addword(wordexp_t *pwordexp, char *word)
{
...
static int
internal_function parse_backslash(char **word, size_t *word_length, size_t *max_length,
...
static int
internal_function parse_qtd_backslash(char **word, size_t *word_length, size_t *max_length,
                                      const char *words, size_t *offset)
{
...
static int
internal_function parse_tilde(char **word, size_t *word_length, size_t *max_length,
...
static int
internal_function do_parse_glob(const char *glob_word, char **word, size_t *word_length,
...
static int
internal_function parse_glob(char **word, size_t *word_length, size_t *max_length,
                             const char *words, size_t *offset, int flags,
...
static int
internal_function parse_squote(char **word, size_t *word_length, size_t *max_length,
                               const char *words, size_t *offset)
{
...
static int
internal_function eval_expr_val(char **expr, long int *result)
{
	int sgn = +1;
	char *digit;
...
static int
internal_function eval_expr_multdiv(char **expr, long int *result)
{
	long int arg;
...
static int
internal_function eval_expr(char *expr, long int *result)
{
	long int arg;
...
static int
internal_function parse_arith(char **word, size_t *word_length, size_t *max_length,
...
static void
internal_function exec_comm_child(char *comm, int *fildes, int showerr, int noexec)
{
...
static int
internal_function exec_comm(char *comm, char **word, size_t *word_length, size_t *max_length,
...
static int
internal_function parse_comm(char **word, size_t *word_length, size_t *max_length,
...
static int
internal_function parse_param(char **word, size_t *word_length, size_t *max_length,
                              const char *words, size_t *offset, int flags, wordexp_t *pwordexp,
...
static int
internal_function parse_dollars(char **word, size_t *word_length, size_t *max_length,
                                const char *words, size_t *offset, int flags,
                                wordexp_t *pwordexp, const char *ifs, const char *ifs_white,
                                int quoted)
{
...
static int
internal_function parse_backtick(char **word, size_t *word_length, size_t *max_length,
                                 const char *words, size_t *offset, int flags,
                                 wordexp_t *pwordexp, const char *ifs, const char *ifs_white)
{
	/* We are poised just after "`" */
...
static int
internal_function parse_dquote(char **word, size_t *word_length, size_t *max_length,
                               const char *words, size_t *offset, int flags,
                               wordexp_t *pwordexp, const char *ifs, const char *ifs_white)
{
