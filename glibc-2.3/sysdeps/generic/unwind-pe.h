...
static inline const unsigned char *read_encoded_value(struct _Unwind_Context *context, unsigned char encoding,
                const unsigned char *p, _Unwind_Ptr *val)
{
...
static inline const unsigned char *read_uleb128(const unsigned char *p, _Unwind_Ptr *val)
{
...
static inline const unsigned char *read_sleb128(const unsigned char *p, _Unwind_Ptr *val)
{
