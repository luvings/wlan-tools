...
static inline int xstat_conv(int vers, struct kernel_stat *kbuf, void *ubuf)
{
	switch (vers) {
...
static inline int xstat64_conv(int vers, struct kernel_stat *kbuf, void *ubuf)
{
...
static inline int xstat32_conv(int vers, struct stat64 *kbuf, struct stat *buf)
{
	switch (vers) {
	case _STAT_VER_LINUX: {
