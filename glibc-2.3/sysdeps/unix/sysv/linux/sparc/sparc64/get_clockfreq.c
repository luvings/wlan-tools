...
static hp_timing_t __get_clockfreq_via_cpuinfo(void)
{
	hp_timing_t result;
	int fd;
...
static hp_timing_t __get_clockfreq_via_proc_openprom(void)
{
	hp_timing_t result;
	int obp_fd;
...
static hp_timing_t __get_clockfreq_via_dev_openprom(void)
{
	hp_timing_t result;
	int obp_dev_fd;
