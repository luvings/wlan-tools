...
static inline char *new_composite_name(int category, const char *newnames[__LC_LAST])
{
	size_t last_len = 0;
	size_t cumlen = 0;
	int i;
...
static inline void setname(int category, const char *name)
{
...
static inline void setdata(int category, struct locale_data *data)
{
