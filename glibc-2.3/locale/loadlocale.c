...
struct locale_data *
internal_function _nl_intern_locale_data(int category, const void *data, size_t datasize)
{
	const struct {
		unsigned int magic;
...
void
internal_function _nl_load_locale(struct loaded_l10nfile *file, int category)
{
	int fd;
	void *filedata;
	struct stat64 st;
...
void
internal_function _nl_unload_locale(struct locale_data *locale)
{
