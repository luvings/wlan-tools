...
static inline void obstack_int32_grow(struct obstack *obstack, int32_t data)
{
...
static inline void obstack_int32_grow_fast(struct obstack *obstack, int32_t data)
{
	if (sizeof(int32_t) == sizeof(int))
...
static inline int utf8_encode(char *buf, int val)
{
	int retval;
