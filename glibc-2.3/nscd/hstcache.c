...
static void cache_addhst(struct database *db, int fd, request_header *req, void *key,
...
void addhstbyname(struct database *db, int fd, request_header *req,
                  void *key, uid_t uid)
{
...
void addhstbyaddr(struct database *db, int fd, request_header *req,
                  void *key, uid_t uid)
{
	/* Search for the entry matching the key.  Please note that we don't
	   look again in the table whether the dataset is now available.  We
...
void addhstbynamev6(struct database *db, int fd, request_header *req,
                    void *key, uid_t uid)
{
	/* Search for the entry matching the key.  Please note that we don't
	   look again in the table whether the dataset is now available.  We
...
void addhstbyaddrv6(struct database *db, int fd, request_header *req,
                    void *key, uid_t uid)
{
	/* Search for the entry matching the key.  Please note that we don't
	   look again in the table whether the dataset is now available.  We
