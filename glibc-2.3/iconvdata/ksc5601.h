...
static inline uint32_t ksc5601_to_ucs4(const unsigned char **s, size_t avail, unsigned char offset)
{
	unsigned char ch = **s;
	unsigned char ch2;
	int idx;
...
static inline size_t ucs4_to_ksc5601_hangul(uint32_t wch, unsigned char *s, size_t avail)
{
	int l = 0;
...
static inline size_t ucs4_to_ksc5601_hanja(uint32_t wch, unsigned char *s, size_t avail)
{
	int l = 0;
...
static inline  size_t ucs4_to_ksc5601_sym(uint32_t wch, unsigned char *s, size_t avail)
{
	int l = 0;
...
static inline size_t ucs4_to_ksc5601(uint32_t wch, unsigned char *s, size_t avail)
{
