...
static inline uint32_t cns11643_to_ucs4(const char **s, size_t avail, unsigned char offset)
{
	unsigned char ch = *(*s);
	unsigned char ch2;
	unsigned char ch3;
...
static inline size_t ucs4_to_cns11643(uint32_t wch, char *s, size_t avail)
{
