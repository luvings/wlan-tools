...
static inline uint32_t cns11643l1_to_ucs4(const unsigned char **s, size_t avail,
...
static inline size_t ucs4_to_cns11643l1(uint32_t wch, unsigned char *s, size_t avail)
{
