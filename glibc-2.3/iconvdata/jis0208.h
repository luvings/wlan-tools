...
static inline uint32_t jisx0208_to_ucs4(const unsigned char **s, size_t avail, unsigned char offset)
{
	unsigned char ch = *(*s);
	unsigned char ch2;
	int idx;
...
static inline size_t ucs4_to_jisx0208(uint32_t wch, char *s, size_t avail)
{
