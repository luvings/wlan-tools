...
static inline int isdirect(uint32_t ch)
{
...
static inline int isxdirect(uint32_t ch)
{
...
static inline int isxbase64(uint32_t ch)
{
...
static inline unsigned char base64(unsigned int i)
{
	if (i < 26)
		return i + 'A';
