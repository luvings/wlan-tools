...
static inline uint32_t jisx0212_to_ucs4(const unsigned char **s, size_t avail, unsigned char offset)
{
...
static inline size_t ucs4_to_jisx0212(uint32_t wch, char *s, size_t avail)
{
