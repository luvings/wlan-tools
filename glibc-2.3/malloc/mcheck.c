...
static void freehook(ptr, caller)
__ptr_t ptr;
...
static __ptr_t mallochook(size, caller)
__malloc_size_t size;
const __ptr_t caller;
{
	struct hdr *hdr;
...
static __ptr_t reallochook(ptr, size, caller)
__ptr_t ptr;
__malloc_size_t size;
const __ptr_t caller;
{
