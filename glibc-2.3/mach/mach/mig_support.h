...
extern __inline vm_size_t __mig_strncpy(char *__dst, const char *__src, vm_size_t __len)
{
	return __stpncpy(__dst, __src, __len) - __dst;
}

extern __inline vm_size_t mig_strncpy(char *__dst, const char *__src, vm_size_t __len)
{
