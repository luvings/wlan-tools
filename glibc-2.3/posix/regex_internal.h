...
static inline void bitset_not(set)
bitset set;
{
	int bitset_i;
...
static inline void bitset_merge(dest, src)
bitset dest;
const bitset src;
{
	int bitset_i;
...
static inline void bitset_not_merge(dest, src)
bitset dest;
const bitset src;
{
	int i;
...
static inline int re_string_char_size_at(pstr, idx)
...
static inline wint_t re_string_wchar_at(pstr, idx)
const re_string_t *pstr;
int idx;
{
	if (MB_CUR_MAX == 1)
...
static int re_string_elem_size_at(pstr, idx)
const re_string_t *pstr;
int idx;
{
#ifdef _LIBC
