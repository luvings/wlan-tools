...
static reg_errcode_t re_compile_internal(preg, pattern, length, syntax)
regex_t *preg;
const char *pattern;
int length;
reg_syntax_t syntax;
...
static reg_errcode_t init_dfa(dfa, pat_len)
re_dfa_t *dfa;
int pat_len;
{
	int table_size;
...
static reg_errcode_t init_word_char(dfa)
re_dfa_t *dfa;
{
	int i, j, ch;
...
static void free_workarea_compile(preg)
regex_t *preg;
{
	re_dfa_t *dfa = (re_dfa_t *) preg->buffer;
...
static reg_errcode_t create_initial_state(dfa)
re_dfa_t *dfa;
{
	int first, i;
	reg_errcode_t err;
...
static reg_errcode_t analyze(dfa)
re_dfa_t *dfa;
{
	int i;
	reg_errcode_t ret;
...
static reg_errcode_t analyze_tree(dfa, node)
re_dfa_t *dfa;
bin_tree_t *node;
{
	reg_errcode_t ret;
...
static void calc_first(dfa, node)
re_dfa_t *dfa;
bin_tree_t *node;
{
	int idx, type;
...
static void calc_next(dfa, node)
re_dfa_t *dfa;
bin_tree_t *node;
{
	int idx, type;
...
static void calc_epsdest(dfa, node)
re_dfa_t *dfa;
bin_tree_t *node;
{
	int idx;
...
static reg_errcode_t duplicate_node(new_idx, dfa, org_idx, constraint)
re_dfa_t *dfa;
int *new_idx, org_idx;
unsigned int constraint;
{
...
static void calc_inveclosure(dfa)
re_dfa_t *dfa;
{
...
static reg_errcode_t calc_eclosure(dfa)
re_dfa_t *dfa;
{
...
static reg_errcode_t calc_eclosure_iter(new_set, dfa, node, root)
re_node_set *new_set;
re_dfa_t *dfa;
int node, root;
{
...
static re_token_t fetch_token(input, syntax)
re_string_t *input;
reg_syntax_t syntax;
{
	re_token_t token;
...
static int peek_token(token, input, syntax)
re_token_t *token;
re_string_t *input;
reg_syntax_t syntax;
{
...
static int peek_token_bracket(token, input, syntax)
re_token_t *token;
re_string_t *input;
reg_syntax_t syntax;
{
...
static bin_tree_t *parse(regexp, preg, syntax, err)
re_string_t *regexp;
regex_t *preg;
reg_syntax_t syntax;
reg_errcode_t *err;
...
static bin_tree_t *parse_reg_exp(regexp, preg, token, syntax, nest, err)
re_string_t *regexp;
regex_t *preg;
re_token_t *token;
reg_syntax_t syntax;
...
static bin_tree_t *parse_branch(regexp, preg, token, syntax, nest, err)
re_string_t *regexp;
regex_t *preg;
re_token_t *token;
reg_syntax_t syntax;
...
static bin_tree_t *parse_expression(regexp, preg, token, syntax, nest, err)
re_string_t *regexp;
regex_t *preg;
re_token_t *token;
reg_syntax_t syntax;
...
static bin_tree_t *parse_sub_exp(regexp, preg, token, syntax, nest, err)
re_string_t *regexp;
regex_t *preg;
re_token_t *token;
reg_syntax_t syntax;
...
static bin_tree_t *parse_dup_op(dup_elem, regexp, dfa, token, syntax, err)
bin_tree_t *dup_elem;
re_string_t *regexp;
re_dfa_t *dfa;
re_token_t *token;
...
static bin_tree_t *parse_bracket_exp(regexp, dfa, token, syntax, err)
re_string_t *regexp;
re_dfa_t *dfa;
re_token_t *token;
reg_syntax_t syntax;
...
static reg_errcode_t parse_bracket_symbol(elem, regexp, token)
bracket_elem_t *elem;
re_string_t *regexp;
re_token_t *token;
{
...
static bin_tree_t *build_word_op(dfa, not, err)
re_dfa_t *dfa;
int not;
reg_errcode_t *err;
{
...
static int fetch_number(input, token, syntax)
re_string_t *input;
re_token_t *token;
reg_syntax_t syntax;
{
...
static bin_tree_t *create_tree(left, right, type, index)
bin_tree_t *left;
bin_tree_t *right;
...
static void free_bin_tree(tree)
bin_tree_t *tree;
{
	if (tree == NULL)
		return;
...
static bin_tree_t *duplicate_tree(src, dfa)
