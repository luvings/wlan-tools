...
/* Set up NIP to run through the services.  If ALL is zero, use NIP's
   ...
   services (left).  */
static enum nss_status setup(void **fctp, const char *func_name, int all)
{
...

static int
internal_function __internal_setnetgrent_reuse(const char *group, struct __netgrent *datap,
                int *errnop)
{
...
static int internal_getnetgrent_r(char **hostp, char **userp, char **domainp,
