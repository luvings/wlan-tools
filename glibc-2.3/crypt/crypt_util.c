...
void _ufc_setup_salt_r(s, __data)
__const char *s;
struct crypt_data *__restrict __data;
{
...
void _ufc_mk_keytab_r(key, __data)
const char *key;
struct crypt_data *__restrict __data;
{
	ufc_long v1, v2, *k1;
...
void _ufc_dofinalperm_r(res, __data)
ufc_long *res;
struct crypt_data *__restrict __data;
{
	ufc_long v1, v2, x;
...
void _ufc_output_conversion_r(v1, v2, salt, __data)
ufc_long v1, v2;
__const char *salt;
struct crypt_data *__restrict __data;
{
...
void __encrypt_r(__block, __edflag, __data)
char *__block;
int __edflag;
struct crypt_data *__restrict __data;
{
