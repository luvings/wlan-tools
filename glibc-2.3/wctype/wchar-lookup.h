...
static __inline int wctype_table_lookup(const char *table, uint32_t wc)
{
...
static __inline int wcwidth_table_lookup(const char *table, uint32_t wc)
{
	uint32_t shift1 = ((const uint32_t *) table)[0];
	uint32_t index1 = wc >> shift1;
	uint32_t bound = ((const uint32_t *) table)[1];
...
static __inline uint32_t wctrans_table_lookup(const char *table, uint32_t wc)
{
	uint32_t shift1 = ((const uint32_t *) table)[0];
	uint32_t index1 = wc >> shift1;
	uint32_t bound = ((const uint32_t *) table)[1];
