...
/* This is for aliases */
static inline void print_aliases(struct aliasent *alias)
{
	unsigned int i = 0;
...
/* This is for group */
static inline void print_group(struct group *grp)
{
	unsigned int i = 0;
...
static inline void print_networks(struct netent *net)
{
	unsigned int i;
	struct in_addr ip;
...
static inline void print_passwd(struct passwd *pwd)
{
...
static inline void print_protocols(struct protoent *proto)
{
	unsigned int i;
...
/* Now is all for rpc */
static inline void print_rpc(struct rpcent *rpc)
{
	int i;
...
/* This is for shadow */
static inline void print_shadow(struct spwd *sp)
{
	printf("%s:%s:",
...
/* build doc */
static inline void build_doc(void)
{
	int i, j, len;
