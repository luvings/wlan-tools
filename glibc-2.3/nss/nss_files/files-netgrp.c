...
enum nss_status _nss_files_setnetgrent(const char *group, struct __netgrent *result)
{
	FILE *fp;
...
enum nss_status _nss_files_getnetgrent_r(struct __netgrent *result, char *buffer,
