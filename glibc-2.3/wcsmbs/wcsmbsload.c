...
struct __gconv_step *
attribute_hidden __wcsmbs_getfct(const char *to, const char *from, size_t *nstepsp)
{
	size_t nsteps;
...
void
internal_function __wcsmbs_clone_conv(struct gconv_fcts *copy)
{
...
int
internal_function __wcsmbs_named_conv(struct gconv_fcts *copy, const char *name)
{
...
void internal_function _nl_cleanup_ctype(struct locale_data *locale)
{
