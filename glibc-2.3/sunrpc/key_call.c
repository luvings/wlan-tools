...
#ifndef SO_PASSCRED
static int
internal_function key_call_keyenvoy(u_long proc, xdrproc_t xdr_arg, char *arg,
...
static int
internal_function key_call_socket(u_long proc, xdrproc_t xdr_arg, char *arg,
                                  xdrproc_t xdr_rslt, char *rslt)
{
	CLIENT *clnt;
	struct timeval wait_time;
...
/* returns 0 on failure, 1 on success */
static int
internal_function key_call_door(u_long proc, xdrproc_t xdr_arg, char *arg,
                                xdrproc_t xdr_rslt, char *rslt)
{
	XDR xdrs;
	int fd, ret;
...
/* returns 0 on failure, 1 on success */
static int
internal_function key_call(u_long proc, xdrproc_t xdr_arg, char *arg,
                           xdrproc_t xdr_rslt, char *rslt)
{
#ifndef SO_PASSCRED
