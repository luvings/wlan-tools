...
static void close_output(const char *outfile)
{
	if (fclose(fout) == EOF) {
...
static void c_output(const char *infile, const char *define, int extend,
                     const char *outfile)
{
	definition *def;
	char *include;
...
static void h_output(const char *infile, const char *define, int extend,
                     const char *outfile)
{
	xdrfunc *xdrfuncp;
	definition *def;
 ...
 */
static void s_output(int argc, const char *argv[], const char *infile, const char *define,
 ...
 */
static void l_output(const char *infile, const char *define, int extend,
                     const char *outfile)
{
	char *include;
	definition *def;
 ...
 */
static void t_output(const char *infile, const char *define, int extend,
                     const char *outfile)
{
	definition *def;
	int foundprogram = 0;
...
static void svc_output(const char *infile, const char *define, int extend,
                       const char *outfile)
{
	definition *def;
	char *include;
...
static void clnt_output(const char *infile, const char *define, int extend,
                        const char *outfile)
{
	definition *def;
	char *include;
...
static char *file_name(const char *file, const char *ext)
{
	char *temp;
