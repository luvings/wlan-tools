 ...
 * sent and received.
 */
CLIENT *clntudp_bufcreate(struct sockaddr_in *raddr, u_long program, u_long version,
...
static enum clnt_stat clntudp_call(cl, proc, xargs, argsp, xresults, resultsp, utimeout)
