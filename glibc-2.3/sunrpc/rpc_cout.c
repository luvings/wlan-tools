...
static void print_prog_header(const proc_list * plist)
{
...
static void print_ifstat(int indent, const char *prefix, const char *type, relation rel,
...
static void inline_struct(definition *def, int flag)
{
	decl_list *dl;
	int i, size;
	decl_list *cur = NULL;
...
static void emit_single_in_line(int indent, declaration *decl, int flag, relation rel)
{
	char *upp_case;
	int freed = 0;
