...
static void udpping(portnum, argc, argv)
u_short portnum;
int argc;
char **argv;
{
...
static void tcpping(portnum, argc, argv)
u_short portnum;
int argc;
char **argv;
{
 ...
 */
static int pstatus(client, prognum, vers)
...
static void pmapdump(argc, argv)
int argc;
char **argv;
{
...
/*ARGSUSED */
static bool_t reply_proc(res, who)
...
static void deletereg(argc, argv)
int argc;
char **argv;
{
...
static void get_inet_address(addr, host)
struct sockaddr_in *addr;
char *host;
{
	register struct hostent *hp;
