...
struct requestlist *
internal_function __gai_find_request(const struct gaicb *gaicbp)
{
...
int
internal_function __gai_remove_request(struct gaicb *gaicbp)
{
	struct requestlist *runp;
...
struct requestlist *
internal_function __gai_enqueue_request(struct gaicb *gaicbp)
{
