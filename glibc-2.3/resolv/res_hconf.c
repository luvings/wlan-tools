...
static const char *arg_service_list(const char *fname, int line_num, const char *args,
                                    unsigned int arg)
{
...
static const char *arg_spoof(const char *fname, int line_num, const char *args, unsigned flag)
{
