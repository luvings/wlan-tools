...
static inline char *local_strdup(const char *s)
{
...
size_t _dl_dst_count(const char *name, int is_path)
{
...
static void
internal_function add_name_to_object(struct link_map *l, const char *name)
{
...
static inline struct r_search_path_elem **fillin_rpath(char *rpath, struct r_search_path_elem **result, const char *sep,
...
static void
internal_function decompose_rpath(struct r_search_path_struct *sps,
...
void
internal_function _dl_init_paths(const char *llp)
{
	size_t idx;
	const char *strp;
...
static int open_verify(const char *name, struct filebuf *fbp)
{
...
struct link_map *
internal_function _dl_map_object(struct link_map *loader, const char *name, int preloaded,
