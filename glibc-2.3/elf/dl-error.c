...
void
internal_function _dl_signal_error(int errcode, const char *objname, const char *occation,
...
int
internal_function _dl_catch_error(const char **objname, const char **errstring,
