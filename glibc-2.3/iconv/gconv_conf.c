...
static int
internal_function detect_conflict(const char *alias)
{
...
/* Add new alias.  */
static inline void add_alias(char *rp, void *modules)
{
...
static inline void
internal_function insert_module(struct gconv_module *newp, int tobefreed)
{
...
/* Add new module.  */
static void
internal_function add_module(char *rp, const char *directory, size_t dir_len, void **modules,
...
static void
internal_function read_conf_file(const char *filename, const char *directory, size_t dir_len,
...
void
internal_function __gconv_get_path(void)
{
...
/* Read all configuration files found in the user-specified and the default
   path.  */
void
attribute_hidden __gconv_read_conf(void)
{
	void *modules = NULL;
	size_t nmodules = 0;
