...
static int
internal_function derivation_lookup(const char *fromset, const char *toset,
...
static void
internal_function add_derivation(const char *fromset, const char *toset,
                                 struct __gconv_step *handle, size_t nsteps)
{
...
void
internal_function __gconv_release_step(struct __gconv_step *step)
{
	if (--step->__counter == 0) {
		/* Call the destructor.  */
...
static int
internal_function gen_steps(struct derivation_step *best, const char *toset,
...
#ifndef STATIC_GCONV
static int
internal_function increment_counter(struct __gconv_step *steps, size_t nsteps)
{
...
static int
internal_function find_derivation(const char *toset, const char *toset_expand,
...
int
internal_function __gconv_compare_alias(const char *name1, const char *name2)
{
	int result;
...
int
internal_function __gconv_find_transform(const char *toset, const char *fromset,
                struct __gconv_step **handle, size_t *nsteps,
                int flags)
{
...
int
internal_function __gconv_close_transform(struct __gconv_step *steps, size_t nsteps)
{
	int result = __GCONV_OK;
	size_t cnt;
...
static void
internal_function free_modules_db(struct gconv_module *node)
{
	if (node->left != NULL)
