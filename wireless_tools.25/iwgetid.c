 ...
 */
static int print_essid(int			skfd,
                       const char 	*ifname,
                       int			format)
{
	struct iwreq		wrq;
 ...
 */
static int print_nwid(int		skfd,
                      const char 	*ifname,
                      int		format)
{
	struct iwreq		wrq;
 ...
 */
static int print_freq(int		skfd,
                      const char 	*ifname,
                      int		format)
{
	struct iwreq		wrq;
 ...
 */
static int print_mode(int		skfd,
                      const char 	*ifname,
                      int		format)
{
	struct iwreq		wrq;
 ...
 * Display the ESSID if possible
 */
static int print_protocol(int		skfd,
                          const char 	*ifname,
                          int		format)
{
	struct iwreq		wrq;
 ...
 */
static int print_one_device(int		skfd,
                            int		format,
                            int		wtype,
                            const char	*ifname)
{
 ...
 */
static int scan_devices(int		skfd,
                        int		format,
                        int		wtype)
{
	char		buff[1024];
